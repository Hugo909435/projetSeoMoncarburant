...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'articles';
    displayName: 'Article';
    description: 'Articles \u00E9ditoriaux du site';
  };
  options: {
...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'authors';
    displayName: 'Author';
    description: 'Auteurs des articles';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Cat\u00E9gories des articles';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiStaticPageStaticPage extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Pages statiques du site (contact, mentions l\u00E9gales, etc.)';
  };
  options: {
    draftAndPublish: false;
  };
