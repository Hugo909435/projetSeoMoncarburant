---
title: "Additifs métalliques : la nouvelle mention sur les pompes à essence"
metaTitle: "Additifs métalliques : nouvelle mention à la pompe"
metaDescription: "Depuis le 27 août 2026, certaines pompes SP95, SP98 et E10 affichent 'Contient des additifs métalliques'. D'où vient cette mention et que signifie-t-elle ?"
slug: "additifs-metalliques-mention-pompe-essence-2026"
excerpt: "Depuis le 27 août 2026, un arrêté oblige les pompes à essence contenant du manganèse à afficher la mention 'Contient des additifs métalliques'. Origine, raisons et conséquences pour votre moteur."
...
pillar: "sp95-vs-sp98"
faq:
  - question: "Qu'est-ce que la mention 'Contient des additifs métalliques' sur les pompes ?"
    answer: "C'est une mention obligatoire depuis le 27 août 2026 pour les pompes de sans-plomb 95, sans-plomb 98 et SP95-E10 dont le carburant contient un additif métallique, en pratique du manganèse ajouté pour augmenter l'indice d'octane. L'affichage doit être visible et lisible directement sur la borne."
  - question: "Quel additif métallique est concerné par cette nouvelle mention ?"
    answer: "Il s'agit essentiellement du MMT (méthylcyclopentadiényle tricarbonyle de manganèse), un composé à base de manganèse utilisé depuis les années 1970 comme antidétonant, en remplacement progressif du plomb. L'arrêté du 22 juillet 2026 plafonne sa teneur à 2 milligrammes de manganèse par litre."
  - question: "Cette obligation d'affichage est-elle vraiment nouvelle ?"
    answer: "Le principe existait déjà dans un arrêté du 10 décembre 2010, mais il était resté largement ignoré des stations. L'arrêté du 22 juillet 2026, publié au Journal officiel le 26 août et applicable dès le lendemain, remet cette obligation au premier plan en l'alignant sur les normes européennes NF EN 228 (essence) et NF EN 590 (gazole) révisées en juillet 2025."
  - question: "Faut-il s'inquiéter pour son moteur si le carburant contient des additifs métalliques ?"
    answer: "Non, dans les proportions autorisées. Le manganèse reste sous un plafond de 2 mg/L, un seuil bien plus faible que les teneurs utilisées dans les années 1970-1980. Aucune étude récente ne montre de risque significatif pour les moteurs modernes ou les systèmes de dépollution à ces niveaux."
  - question: "Toutes les stations-service sont-elles concernées ?"
    answer: "Non. La mention ne s'affiche que sur les pompes qui distribuent effectivement un carburant contenant des additifs métalliques. De nombreux raffineurs français n'en ajoutent pas ou plus, ce qui explique que la mention reste rare sur le terrain malgré l'obligation légale."
draft: false
---
...
<p class="text-sm text-slate-500 italic">Photo : Syced, domaine public (CC0), via Wikimedia Commons.</p>

Cet article, rédigé par [Hugo Beignon](/auteur/hugo-beignon/), explique d'où vient cette mention, ce qu'elle signifie concrètement et si elle doit vous inquiéter.
...
Pour aller plus loin sur les différences entre les carburants distribués en France, notre [guide complet SP95 vs SP98](/piliers/sp95-vs-sp98/) détaille les écarts d'indice d'octane et leur impact réel sur le moteur.
