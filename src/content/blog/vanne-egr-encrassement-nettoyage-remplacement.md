---
title: "Vanne EGR : rôle, encrassement, nettoyage ou remplacement"
metaTitle: "Vanne EGR : encrassement, nettoyage ou remplacement"
metaDescription: "À quoi sert la vanne EGR, pourquoi elle s'encrasse et comment savoir s'il faut la nettoyer ou la changer. Symptômes, causes et coûts expliqués simplement."
slug: "vanne-egr-encrassement-nettoyage-remplacement"
excerpt: "La vanne EGR recycle une partie des gaz d'échappement pour réduire la pollution, mais s'encrasse avec le temps. Symptômes, causes et solutions pour la remettre en état."
...
faq:
  - question: "Peut-on rouler avec une vanne EGR encrassée ?"
    answer: "Oui, dans un premier temps, mais la voiture perd en puissance et consomme plus. À terme, une vanne bloquée peut endommager d'autres pièces comme le filtre à particules ou provoquer une panne plus sérieuse."
  - question: "Combien coûte le nettoyage d'une vanne EGR ?"
    answer: "Un nettoyage en garage coûte généralement entre 100 et 250 euros selon le véhicule et la difficulté d'accès. Un produit nettoyant à faire soi-même revient à 20 ou 30 euros, mais ne fonctionne que sur un encrassement léger."
  - question: "Peut-on nettoyer une vanne EGR sans la démonter ?"
    answer: "Il existe des produits à injecter par l'admission d'air pour un nettoyage léger, mais un encrassement important nécessite un démontage complet pour atteindre les dépôts durcis dans les canaux internes."
  - question: "Le voyant moteur s'allume-t-il toujours en cas de vanne EGR encrassée ?"
    answer: "Pas systématiquement. Le calculateur détecte surtout les défauts électriques ou les positions incohérentes du capteur. Un encrassement mécanique progressif peut passer inaperçu du voyant pendant un moment, même si les symptômes sont déjà là."
  - question: "L'EGR encrasse-t-elle plus les diesels que les essences ?"
    answer: "Oui, nettement. Les moteurs diesel produisent davantage de suies, qui se déposent plus facilement dans les canaux de la vanne. Les essences récentes en sont aussi équipées, mais le phénomène y est généralement plus lent."
draft: false
---
...
- **Entretien complet du véhicule**, pour situer la vanne EGR dans l'ensemble des points à surveiller : [entretien voiture, le guide complet](/piliers/entretien-voiture-guide/).
- **Diesel ou essence à l'achat**, la vanne EGR fait partie des pièces à surveiller sur un diesel d'occasion : [diesel ou essence, quel choix en 2026](/blog/diesel-ou-essence-2026-achat/).
- **Réduire sa consommation**, un moteur bien entretenu, EGR comprise, consomme moins sur la durée : [réduire sa facture de carburant](/piliers/reduire-facture-carburant/).
