# Graph Report - projetSeoMoncarburant  (2026-08-26)

## Corpus Check
- 540 files · ~1,463,874 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1511 nodes · 1649 edges · 251 communities (122 shown, 129 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6939fbdc`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Article Layout Components|Article Layout Components]]
- [[_COMMUNITY_Leaflet Map Core|Leaflet Map Core]]
- [[_COMMUNITY_Fuel Search Interface|Fuel Search Interface]]
- [[_COMMUNITY_City Identity & Fuel Config|City Identity & Fuel Config]]
- [[_COMMUNITY_Project Dependencies|Project Dependencies]]
- [[_COMMUNITY_Fuel Data Pipeline|Fuel Data Pipeline]]
- [[_COMMUNITY_Site Configuration & Sitemap|Site Configuration & Sitemap]]
- [[_COMMUNITY_Department & Local Content|Department & Local Content]]
- [[_COMMUNITY_Fuel Price Blog Articles|Fuel Price Blog Articles]]
- [[_COMMUNITY_French City Emblems|French City Emblems]]
- [[_COMMUNITY_Leaflet Map Rendering|Leaflet Map Rendering]]
- [[_COMMUNITY_Leaflet Map Interactions|Leaflet Map Interactions]]
- [[_COMMUNITY_Brand Station Map Script|Brand Station Map Script]]
- [[_COMMUNITY_Flag Fetcher Script|Flag Fetcher Script]]
- [[_COMMUNITY_Cookie Consent UI|Cookie Consent UI]]
- [[_COMMUNITY_Fuel Economy Calculators|Fuel Economy Calculators]]
- [[_COMMUNITY_Contact Form Handler|Contact Form Handler]]
- [[_COMMUNITY_Leaflet Geometry Utils|Leaflet Geometry Utils]]
- [[_COMMUNITY_Contact Page UI|Contact Page UI]]
...
2. `scripts` - 19 edges
3. `main()` - 13 edges
4. `../../../data/departments.json` - 13 edges
5. `../components/HeroMap.astro` - 13 edges
6. `SEO Audit` - 13 edges
7. `SEO Audit` - 13 edges
8. `Audit GEO (Generative Engine Optimization) — mon-carburant.com` - 13 edges
9. `../components/FullStationsMap.astro` - 12 edges
10. `../../../data/fuel/meta.json` - 12 edges
...
- `mon-carburant.com Brand Logo (Colored)` --semantically_similar_to--> `mon-carburant.com Favicon Icon`  [INFERRED] [semantically similar]
  Logos/colored-logo.svg → public/favicon.svg
- `mon-carburant.com Brand Logo (Transparent Background)` --semantically_similar_to--> `mon-carburant.com Favicon Icon`  [INFERRED] [semantically similar]
  Logos/transparent-logo.svg → public/favicon.svg
- `Esso Carburant : prix et stations en France 2026` --semantically_similar_to--> `Intermarché carburant : prix coûtant et bons plans 2026`  [INFERRED] [semantically similar]
  src/content/blog/esso-carburant-prix-2026.md → src/content/blog/intermarche-carburant-prix-coutant-2026.md
- `Esso Carburant : prix et stations en France 2026` --semantically_similar_to--> `Super U carburant : parmi les moins chers de France en 2026`  [INFERRED] [semantically similar]
  src/content/blog/esso-carburant-prix-2026.md → src/content/blog/super-u-carburant-prix-2026.md
- `Prix carburant Total et TotalEnergies en France 2026` --semantically_similar_to--> `Intermarché carburant : prix coûtant et bons plans 2026`  [INFERRED] [semantically similar]
  src/content/blog/total-carburant-prix-2026.md → src/content/blog/intermarche-carburant-prix-coutant-2026.md

## Import Cycles
- None detected.

## Communities (251 total, 129 thin omitted)
...
Cohesion: 0.17
Nodes (6): ../components/FuelSearch.astro, ../components/Newsletter.astro, ../../../data/fuel/meta.json, ../../../../data/fuel/stats-by-department.json, ../../../data/fuel/stats-national.json, webAppSchema

### Community 3 - "City Identity & Fuel Config"
Cohesion: 0.18
Nodes (8): ../../../data/local-content, ../../utils/dept-intro, ../../../components/LocalIdentity.astro, deptContent, LocalContent, LocalFact, regionContent, stationUrl()
...
Cohesion: 0.09
Nodes (34): BRAND_DIR, BRAND_MAP, BRAND_MAP_FILE, buildCityNames(), buildDepStats(), buildNationalStats(), buildRegionStats(), CHECK_ONLY (+26 more)

### Community 6 - "Site Configuration & Sitemap"
Cohesion: 0.09
Nodes (19): cityDir, deps, __dirname, download(), files, OUT, ROOT, sleep() (+11 more)
...
Cohesion: 0.62
Nodes (7): Esso Carburant : prix et stations en France 2026, Intermarché carburant : prix coûtant et bons plans 2026, Leclerc : carburant à prix coûtant les 3 et 4 juillet 2026, Prix du carburant 2026 : évolution, causes et prévisions, Super U carburant : parmi les moins chers de France en 2026, Total Access carburant : le low-cost de TotalEnergies en 2026, Prix carburant Total et TotalEnergies en France 2026

### Community 9 - "French City Emblems"
Cohesion: 0.14
...
Cohesion: 0.22
Nodes (14): ai(), at(), Ci(), d(), e(), G(), hi(), i() (+6 more)

### Community 12 - "Brand Station Map Script"
Cohesion: 0.24
Nodes (11): BRAND_MAP, buildSpatialIndex(), __dirname, fetchOsmStations(), findNearest(), haversine(), main(), normalizeBrand() (+3 more)

### Community 13 - "Flag Fetcher Script"
Cohesion: 0.21
...
Cohesion: 0.31
Nodes (8): ../components/CookieBanner.astro, apply(), hideBanner(), hideModal(), load(), loadAds(), loadGA4(), showModal()
...
Cohesion: 0.40
Nodes (5): h(), Jt(), ke(), ne(), we()

### Community 21 - "Community 21"
Cohesion: 0.67
Nodes (4): Cannes city flag, Fréjus city flag, Marseille city flag, Martigues city flag
...
Cohesion: 1.00
Nodes (3): mon-carburant.com Brand Logo (Colored), mon-carburant.com Brand Logo (Transparent Background), mon-carburant.com Favicon Icon

### Community 24 - "Community 24"
Cohesion: 0.67
Nodes (3): Cholet city flag, La Roche-sur-Yon city flag, Laval city flag
...
Cohesion: 0.15
Nodes (17): ../../../utils/station-waves, ../components/FullStationsMap.astro, ../components/HeroMap.astro, ../../../data/departments.json, ../../../data/fuel/city-names.json, ../data/station-brands.json, breadcrumb, jsonLd (+9 more)
...
Cohesion: 0.17
Nodes (11): 10. Comparer les prix avant de faire le plein, 1. Anticiper les ralentissements, 2. Gonfler les pneus à la bonne pression, 3. Réduire sa vitesse sur autoroute, 4. Monter les rapports de vitesse rapidement, 5. Éviter la climatisation inutile, 6. Couper le moteur à l'arrêt, 7. Alléger le véhicule (+3 more)
...
Cohesion: 0.33
Nodes (5): Consignes pour Claude — projet mon-carburant.com, graphify, ❌ JAMAIS de tirets longs, ❌ Limites de caractères dans le frontmatter, Règles de rédaction (NON NÉGOCIABLES)
...
Cohesion: 0.33
Nodes (5): Ce que l'État peut, et ne peut pas, faire sur le prix à la pompe, L'ampleur du choc en 2026, Le déclencheur : le blocage du détroit d'Ormuz, Pourquoi les prix rebaissent depuis juin, Pourquoi un blocage si lointain fait monter votre plein
...
Cohesion: 0.33
Nodes (5): Combien peut-on économiser ?, Comment en profiter au maximum, Et chez les autres enseignes cet été 2026 ?, Qu'est-ce que le carburant à prix coûtant ?, Une opération fréquente chez Leclerc
...
Cohesion: 0.22
Nodes (11): ../components/AdUnit.astro, ../../components/ArticleLayout.astro, ./AuthorBox.astro, ../../components/Breadcrumb.astro, breadcrumbSchema, ./FAQ.astro, faqSchema, ../../components/PillarLayout.astro (+3 more)
...
Cohesion: 0.25
Nodes (4): ../styles/global.css, ../components/Footer.astro, ../components/SEO.astro, ../../../layouts/BaseLayout.astro
...
Cohesion: 0.22
Nodes (5): ../components/Header.astro, allDepts, brands, navLinks, ../../../../data/fuel/brands.json

### Community 203 - "Community 203"
Cohesion: 0.15
Nodes (11): dateFormatter, history, lines, padding, values, FUEL_COLORS, FUEL_KEYS, FuelConfig (+3 more)
...
Cohesion: 0.22
Nodes (6): ../../utils/brand-logo, ../utils/prix-coutant, ../components/AlertePrixCoutant.astro, ../../../../components/BrandCell.astro, ../../../components/BrandLogo.astro, src
...
Cohesion: 0.25
Nodes (7): Combien on économise vraiment : la nuance qui compte, Comment ne pas rater la prochaine, Leclerc, Intermarché, Carrefour : silence radio en août, Les fenêtres à surveiller d'ici la rentrée, Où en sont les prix à la pompe en août 2026, Système U a ouvert le mois, les 2 et 3 août, TotalEnergies : un plafond plutôt qu'une opération
...
Cohesion: 0.33
Nodes (4): articleLastmods, siteLastmod, weakUrls, ../../../data/fuel/config

### Community 223 - "Community 223"
Cohesion: 0.33
Nodes (5): Ce que ça change concrètement, Faut-il attendre une baisse ?, La parenthèse sous 2 € s'est refermée le 14 août, Pourquoi le gazole et pas l'essence, Six semaines de relevés, un renversement complet
...
Cohesion: 0.33
Nodes (5): Ce qu'il faut retenir avant l'été, Ce que dit le communiqué de TotalEnergies, Le programme Avantage Carburant, une exception à part, Pourquoi les prix remontent depuis la mi-juillet, Une communication qui tombe (bien) à point nommé

### Community 227 - "Community 227"
Cohesion: 0.33
Nodes (5): articleSchema, authors, blog, collections, piliers
...
Cohesion: 0.14
Nodes (10): ../../../utils/city-identity, ../../../utils/city-intro, ../../../utils/format-maj, ../../../components/StationLink.astro, url, breadcrumb, hasCityBlason, introSentences (+2 more)
...
Cohesion: 0.47
Nodes (5): ../../../utils/escape-html, initMap(), loadCss(), loadScript(), mapEl
...
## Knowledge Gaps
- **949 isolated node(s):** `siteLastmod`, `weakUrls`, `articleLastmods`, `name`, `type` (+944 more)
...
- **Why does `../../../layouts/BaseLayout.astro` connect `Community 200` to `Article Layout Components`, `Fuel Search Interface`, `Community 195`, `City Identity & Fuel Config`, `Community 202`, `Cookie Consent UI`, `Contact Page UI`, `Community 246`, `Community 250`, `Community 157`, `Community 191`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `../../../data/departments.json` connect `Community 157` to `Fuel Search Interface`, `City Identity & Fuel Config`, `Community 202`, `Community 246`, `Community 191`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `../components/FuelSearch.astro` connect `Fuel Search Interface` to `Community 157`, `Fuel Economy Calculators`?**
