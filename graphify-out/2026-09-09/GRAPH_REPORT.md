# Graph Report - projetSeoMoncarburant  (2026-09-08)

## Corpus Check
- 610 files · ~1,431,125 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1744 nodes · 1916 edges · 273 communities (143 shown, 130 thin omitted)
- Extraction: 97% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db89ef13`
...
## Communities (273 total, 130 thin omitted)
...
Cohesion: 0.18
Nodes (9): ../../components/AdUnit.astro, ../components/AlertePrixCoutant.astro, ../components/FuelSearch.astro, ../../../data/departments.json, ../../../data/fuel/autoroutes.json, ../../data/fuel/meta.json, ../../../../data/fuel/stats-by-department.json, ../../data/fuel/stats-national.json (+1 more)
...
Cohesion: 0.08
Nodes (22): ../../../data/local-content, ../../../utils/city-identity, ../../../utils/city-intro, ../../utils/dept-intro, ../../../utils/station-waves, ../../../components/LocalIdentity.astro, ../../../components/StationLink.astro, url (+14 more)
...
Cohesion: 0.15
Nodes (17): ../../../utils/escape-html, ../components/FullStationsMap.astro, ../components/HeroMap.astro, ../data/station-brands.json, BRAND_LOGO_ALIASES, BRAND_LOGO_EXTS, Dimensions, getBrandLogoDimensions() (+9 more)
...
Cohesion: 0.10
Nodes (18): articleLastmods, siteLastmod, weakUrls, ../../data/fuel/config, ../../../../utils/station-hours, ../../../../utils/station-intro, ../../../data/fuel/city-names.json, FUEL_KEYS (+10 more)
...
Cohesion: 0.14
Nodes (7): ../../../utils/brand-logo, ../../../utils/format-maj, ../utils/prix-coutant, ../../../../components/BrandCell.astro, ../../../components/BrandLogo.astro, src, formatMaj()
