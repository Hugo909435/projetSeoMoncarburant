...
## Corpus Check
- 615 files · ~1,453,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1781 nodes · 1951 edges · 276 communities (145 shown, 131 thin omitted)
- Extraction: 97% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e072a05`
...
## Communities (276 total, 131 thin omitted)

### Community 0 - "Article Layout Components"
Cohesion: 0.11
Nodes (20): ../../../utils/station-waves, ../components/FullStationsMap.astro, ../components/HeroMap.astro, ../../../components/Pagination.astro, ../../../components/StationLink.astro, url, ../../../data/fuel/city-names.json, FUEL_KEYS (+12 more)
...
Cohesion: 0.24
Nodes (6): ../components/ArticleCard.astro, dateFormatted, string, displayed, personSchema, string
...
Cohesion: 0.12
Nodes (13): ../../utils/dept-intro, breadcrumb, FUELS, introSentences, jsonLdBreadcrumb, neighborDepts, string, buildDeptIntro() (+5 more)
...
Cohesion: 0.22
Nodes (9): ../../components/AdUnit.astro, ../../components/ArticleLayout.astro, ./AuthorBox.astro, ./FAQ.astro, ../components/Newsletter.astro, ../../components/PillarLayout.astro, encodedTitle, encodedUrl (+1 more)
...
Cohesion: 0.06
Nodes (33): articleLastmods, siteLastmod, weakUrls, ../../../../utils/station-hours, ../../../../utils/station-intro, ../../../../components/StationMiniMap.astro, initMap(), loadCss() (+25 more)
...
Cohesion: 0.40
Nodes (3): ../../components/Breadcrumb.astro, breadcrumbSchema, breadcrumb
...
- **Why does `../../layouts/BaseLayout.astro` connect `Community 191` to `Article Layout Components`, `Community 257`, `Fuel Search Interface`, `Community 195`, `City Identity & Fuel Config`, `Department & Local Content`, `Community 169`, `Community 202`, `Community 203`, `Community 205`, `Cookie Consent UI`, `Community 246`, `Community 251`?**
...
- **Should `Article Layout Components` be split into smaller, more focused modules?**
